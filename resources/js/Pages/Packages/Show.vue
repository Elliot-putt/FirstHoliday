<template>
    ...
    <TitleLayout :title="'Show Package - ' + pack.hotel.name"
    ...
    <div class=" mb-4 mx-2">
        <div class=" card-body">
            <div class='row justify-content-center m-4 card-package col-10 mx-auto'>
                <h3 class="text-center text-secondary" v-text="pack.hotel.name +  ' Hotel'"></h3>
                <div class="d-flex justify-content-center">
                    <div class="d-flex my-3 justify-content-center">

                        <img class="img-package img-thumbnail" src="https://loremflickr.com/g/190/140/paris"
                             alt="Hotel img">
                    </div>
